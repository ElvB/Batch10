...
public class Methods1 {
    public static void main(String[] args) {
        ...
        // String is immutable which means original value will not change
        // unless you reassign it or create a new String variable
        ...
        // city.charAt(9); // error since there no index of 9
