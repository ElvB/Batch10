...
public class Practice1 {
    public static void main(String[] args) {
        ...
        map.put("33", "Zack"); // it is resigning new value
        System.out.println(map);
        ...
        map.put(null, "Arzu");// it is resigning new value before null=Jenny, now -> null=Arzu
        System.out.println(map);

        map.put("55", null);
        map.put("66", null);
        map.put("77", null);
        System.out.println(map); // null=Arzu, 55=null, 66=null
